# Contributing to AI Proposal Studio

AI Proposal Studio is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A proposal and scoping assistant for assumptions, exclusions, deliverables, acceptance criteria, timelines, risk flags, pricing bands, and prompt-pack exports.
