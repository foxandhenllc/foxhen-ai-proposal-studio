...
- Demo promise: Convert rough job posts into scoped milestones, risk flags, estimates, and buyer-ready proposal notes.
- Fictional sample object: proposal package
...
Fork AI Proposal Studio as a public-safe client demo for ai-assisted estimating. Keep all records fictional, update `src/data.ts`, preserve the readiness board and export flow, and publish only after the build passes.
